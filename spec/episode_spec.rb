RSpec.describe EZTVWrapper::Episode do
  ...
  describe "#links" do
    it "returns a collection of valid links of an episode" do
      expect(valid_episode.links).to eql episode_hash.fetch(:episode_links)
      expect(valid_episode.links.fetch(:episode_url)).to eql "/ep/153624/mr-robot-s02e06-proper-720p-hdtv-x264-killers/"
      expect(valid_episode.links.fetch(:torrent_url)).to eql "https://zoink.ch/torrent/Mr.Robot.S02E06.PROPER.720p.HDTV.x264-KILLERS[eztv].mkv.torrent"
      expect(valid_episode.links.fetch(:magnet_uri)).to eql "magnet:?xt=urn:btih:4de55d9171f25362860ed72b0e9c678b087dcaae&dn=Mr.Robot.S02E06.PROPER.720p.HDTV.x264-KILLERS%5Beztv%5D.mkv%5Beztv%5D&tr=udp%3A%2F%2Ftracker.coppersurfer.tk%3A80&tr=udp%3A%2F%2Fglotorrents.pw%3A6969%2Fannounce&tr=udp%3A%2F%2Ftracker.leechers-paradise.org%3A6969&tr=udp%3A%2F%2Ftracker.opentrackr.org%3A1337%2Fannounce&tr=udp%3A%2F%2Fexodus.desync.com%3A6969"
    end
  end
end
